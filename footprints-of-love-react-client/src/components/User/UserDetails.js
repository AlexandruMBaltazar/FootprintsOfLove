...
const UserDetails = (props) => {
  ...
  const types = ["Basics", "Looks", "Background", "Lifestyle", "Family"];
  ...
  let pageContent = types.map((type) => {
    let detailsContent;
      ...
      case "Looks":
        detailsContent = (
          <Details
            key={type}
            type={type}
            details={[height + " cm", body_type && body_type.value]}
            icon={
              <svg
                width="24"
                height="25"
          ...
          <Details
            ...
            icon={
              ...
              >
                <title>Combined Shape</title>
                <g id="Symbols" fill="none" fill-rule="evenodd">
                  <g id="Icon/Background/24" fill="#1A1A1A" fill-rule="nonzero">
                    <path
      ...
      case "Family":
        detailsContent = (
          <Details
            key={type}
            type={type}
            details={[child && child.value, pet && pet.value]}
            icon={
              <svg
                width="24"
                height="20"
  ...
  return <div className="col-4">{pageContent}</div>;
};
